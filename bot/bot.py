...
def reminderMessage(bot,students,exam):
    for student in students:
        bot.send_message(student[2], f"📅Reminder \n Your {exam[1]} exam is on {exam[3]}")
        ...
        if message['type'] == 'message':
            ...
            match data['event']:
                ...
                case 'activeReminder':
                    ...
                    if status:
                        bot.send_message(groupID, ("✅The Reminder successfully activated"))
                case 'deactiveReminder':
                    ...
                    if status:
                        bot.send_message(groupID,("✅The Reminder successfully deactivated"))
